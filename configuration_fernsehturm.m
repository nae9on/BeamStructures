...
function [out1,out2,out3,out4,out5,out6,out7,out8,out9] = configuration_fernsehturm(flag)
...
th = pi/10;
beam_config_matrix = [[0 0] 4 pi/2; 
                      [1 0] 4 pi/2;   
                      [0 4] 1 6*th;
                      [-1*cos(4*th) 4+1*sin(4*th)] 1 2*th;
                      [1+1*cos(4*th) 4+1*sin(4*th)] 1 8*th;
                      [1 4] 1 4*th;
                      [0 4] 1 0;
                      [0.5 4+1*sin(4*th)+1*sin(2*th)] 1 pi/2];
...
% no_seperation_between_beams = [beam_i beam_j end(L/R)_of_beam_i end(L/R)_of_beam_j];
no_seperation_between_beams = [1 3 1 0; 1 7 1 0; 2 6 1 0; 2 7 1 1; 3 4 1 0; 6 5 1 0; 4 8 1 0; 5 8 1 0];

% no_rotation_between_beams = [beam_i beam_j end(L/R)_of_beam_i end(L/R)_of_beam_j];
no_rotation_between_beams   = [1 3 1 0; 1 7 1 0; 2 6 1 0; 2 7 1 1; 3 4 1 0; 6 5 1 0; 4 8 1 0; 5 8 1 0];
...
no_rotation_about_wall = [0 1; 0 2]; 

% plot parameteres
plot_window_center = [0.5 3];
