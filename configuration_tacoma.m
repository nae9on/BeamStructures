...
function [out1,out2,out3,out4,out5,out6,out7,out8,out9] = configuration_tacoma(flag)
...
th = atan(0.5);
beam_config_matrix = [[-4 0] sqrt(5) th; 
                      [-4 0] 2 0;   
                      [-2 0] 1 pi/2;
                      [-2 1] sqrt(5) -th;
                      [-2 0] 2 0;
...
% no_seperation_between_beams = [beam_i beam_j end(L/R)_of_beam_i end(L/R)_of_beam_j];
no_seperation_between_beams = [1 2 0 0; 2 3 1 0; 1 3 1 1; 2 5 1 0; 1 4 1 0; 4 5 1 1; 
                               9 10 0 0; 10 8 1 0; 9 8 1 1; 10 7 1 0; 9 6 1 0; 6 7 1 1; 5 7 1 1;
                               11 1 0 0; 12 3 0 0; 13 8 0 0; 14 9 0 0];
                           
% no_rotation_between_beams = [beam_i beam_j end(L/R)_of_beam_i end(L/R)_of_beam_j];                           
no_rotation_between_beams   = [1 2 0 0; 2 3 1 0; 1 3 1 1; 2 5 1 0; 1 4 1 0; 4 5 1 1; 
                               9 10 0 0; 10 8 1 0; 9 8 1 1; 10 7 1 0; 9 6 1 0; 6 7 1 1; 5 7 1 1;
                               11 1 0 0; 12 3 0 0; 13 8 0 0; 14 9 0 0];
...
no_seperation_from_wall = [0 2; 0 10; 0 3; 0 8; 0 4; 0 6]; 
...
no_rotation_about_wall = [0 2; 0 10; 0 3; 0 8; 0 4; 0 6];  

%plot parameteres
plot_window_center = [0 0];
